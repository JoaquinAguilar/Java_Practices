...
public class CalendarioFF extends JFrame implements ActionListener {

    private JLabel etiqueta,lugarL, actividadL;// horaL, ;
    private JTextField mes, fecha, lugarT;//horaT
    ...
    public static void main(String args[]) {
        ...
        CalendarioFF cal = new CalendarioFF();
...
//        p2.add(fecha);
    ...
    public boolean espaciosLlenos() { // Retorna false si alguno de los espacios de Hora, Lugar y Actividad estan vacios
        ...
        if (!lugarT.getText().equals("") && !actividadT.getText().equals("")) {
            retorno = true;
        }
    ...
    public void guardarRecordatorio() { // Guarda en archivo lo que se escribio en los espacios de Hora, Lugar y Actividad
        ...
        try {
            ...
            if (espaciosLlenos()) {
                ...
                String dat = "";
                String filenametxt = String.valueOf("recordatorio" + cantidadArchivos + ".ics");
    ...
    public void guardarCantidad() { // Guarda en un archivo la cantidad de archivos con recordatorios que han sido generados
        ...
        try {
            ...
            File archivo = new File("cantidadArchivos.ics");
            ...
            File f = new File("cantidadArchivos.ics");

            FileInputStream fi = new FileInputStream(f);

            origin = new BufferedInputStream(fi, buffer);

            ZipEntry entry = new ZipEntry("cantidadArchivos.ics");
    ...
    public void verRecordatorio() { // Lee desde los archivos con recordatorios y extrae su informacion
        ...
        try {
            ...
            for (int i = 1; i < cantidadArchivos; i++) {
                ...
                filenametxt = "recordatorio" + i + ".ics";
    ...
    public int obtenerCantidad() { // Lee desde el archivo cantidadArchivos.zip la cantidad de archivos que han sido generados
        ...
        try {
            ...
            DataInputStream input = new DataInputStream(new FileInputStream("cantidadArchivos.ics"));
