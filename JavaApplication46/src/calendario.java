	...
	public void guardarRecordatorio() { // Guarda en archivo lo que se escribio en los espacios de Lugar y Actividad
		...
		try {
			...
			if(espaciosLlenos()) {
				...
				String dat = "";
                                String ical= "";
                                String filenameical = String.valueOf("recordatorio"+cantidadArchivos+".ics");
                                String filenameicalzip = String.valueOf("recordatorio"+cantidadArchivos+".zip");
				...
				dat += actividadT.getText() + "\n";
                                ...
                                ical +=String.valueOf(mesTemporal+ "\n");
                                ical +=String.valueOf(datoSeleccionado);
                                ical += lugarT.getText() + "\n";
...
try {
			...
			if(espaciosLlenos()) {
				...
				cantidadArchivos++;
                                ...
                                // Parte importante
                                ical +=String.valueOf(anoTemporal + mesTemporal + datoSeleccionado + "\n");
                                ical += lugarT.getText() + "\n";
                                ical += actividadT.getText() + "\n";
